...
object SdJwtVcClaims {
    ...
    val AcademicProgram: ClaimDefinition =
        ClaimDefinition(
            path = ClaimPath.claim("academic_program"),
            mandatory = true,
            display = mapOf(Locale.ENGLISH to "Academic Program"),
        )
    val ProgramCode: ClaimDefinition =
        ClaimDefinition(
            path = ClaimPath.claim("program_code"),
            mandatory = true,
            display = mapOf(Locale.ENGLISH to "Program Code"),
        )
    val DegreeTitle: ClaimDefinition =
        ClaimDefinition(
            path = ClaimPath.claim("degree_title"),
            mandatory = true,
            display = mapOf(Locale.ENGLISH to "Degree Title"),
        )
    ...
    val LearnerIdentificationType: ClaimDefinition =
        ClaimDefinition(
            path = ClaimPath.claim("learner_identification_type"),
            mandatory = true,
            display =
                mapOf(
                    Locale.ENGLISH to "Learner identification type",
                ),
        )
