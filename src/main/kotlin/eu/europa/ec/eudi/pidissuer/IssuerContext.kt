...
internal class AppBeans :
    BeanRegistrarDsl({
        ...
        // Piloto UIS: conexión dedicada al padrón de graduados (Postgres
        // externo). lazyInit=true porque solo se necesita si
        // issuer.learningCredential.enabled es true.
        registerBean(lazyInit = true) { env.academicRegistryClient() }
